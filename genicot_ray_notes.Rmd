...
To formalize the problem of a representative parent in this model, define $f(k) = \rhok$, the production function that turns investment $k$ into next-period wealth. Let $k(z) = f^{-1}(z)$ be the inverse, which maps desired next-period wealth into current investment. The parent's problem is now
...
### Dynastic Equilibrium with Aspirations
