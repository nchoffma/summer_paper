...
# Inputs
R = 1.5
γ = 0.861 # zero in [0.86, 0.861] y0 = 2.75

# R = 1.49
# γ = 0.85 # zero in [0.85, 0.86] y0 = 4.7

# A small decrease in R leads to a huge increase in Y, have to figure this out


# Y_0 = 1.5
# test_ums = range(-8., -1., length = 71)
# testvals = [test_shoot(test_ums[i], Y_0) for i in 1:length(test_ums)]
...
totU = gauss_leg(t -> pkc_integrand(t, gpath), 50, θ_min, θ_max)
